...
build_options = {
    ...
    "silent_level": 1,
    "silent": True,
    "excludes": ["PyQt6", "pydoc_data", "email", "tkinter", "PyQt5", "PySide2", "unittest"],
    "bin_excludes": ["Qt6Pdf.dll", "Qt6Qml.dll", "Qt6Quick.dll", "Qt6WebEngineCore.dll", "Qt6VirtualKeyboard.dll"],
